...
ACCOUNTS = [
    ...
    },
    {
        ...
        "context": """
            ...
            Ціль реклами: переписки в Instagram та продажі через переписки.
            Цільова аудиторія: сім'ї та пари, 25-55 років.
            Нормальний CTR: від 1.5%
            Головні метрики: переписки в Instagram, нові підписники Instagram.
            Аналізуй переписки як основний результат для кампаній з ціллю MESSAGES/OUTCOME_ENGAGEMENT.
            Аналізуй CPR відносно динаміки кампанії та порівняння з вчора, не по фіксованій нормі.
        """
    },
    {
        "id": "act_1869935991029390",
        "name": "HT 2833",
        "bot_token": os.environ.get("TELEGRAM_BOT_TOKEN_4", ""),
        "chat_ids": [
            os.environ.get("TELEGRAM_CHAT_ID", ""),
            os.environ.get("TELEGRAM_CHAT_ID_7", ""),
        ],
        "context": """
            C2C платіжне рішення для бізнесу.
            Ціль реклами: залучення нових клієнтів та лідів.
            Нормальний CTR: від 1.5%
            Аналізуй CPR відносно динаміки кампанії та порівняння з вчора, не по фіксованій нормі.
        """
    },
